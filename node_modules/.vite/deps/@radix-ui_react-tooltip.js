...
function useComposedRefs3(...refs) {
  return React14.useCallback(composeRefs3(...refs), refs);
}
...
var useLayoutEffect22 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React18.useLayoutEffect : () => {
};
...
var useLayoutEffect23 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React19.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-use-size/dist/index.mjs
function useSize(element) {
  const [size3, setSize] = React20.useState(void 0);
  useLayoutEffect23(() => {
    if (element) {
...
var PopperAnchor = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime8.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var useLayoutEffect24 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React23.useLayoutEffect : () => {
};
...
var Portal = React24.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime10.jsx)(Primitive4.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useComposedRefs4(...refs) {
  return React25.useCallback(composeRefs4(...refs), refs);
}

// node_modules/@radix-ui/react-presence/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var React26 = __toESM(require_react(), 1);
var useLayoutEffect25 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React26.useLayoutEffect : () => {
};
...
var Presence = (props) => {
  ...
  const ref = useComposedRefs4(presence.ref, getElementRef(child));
    ...
    if (node) {
      const handleAnimationEnd = (event) => {
        ...
        if (event.target === node && isCurrentAnimation) {
          ReactDOM7.flushSync(() => send("ANIMATION_END"));
        }
      };
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  const Node2 = React29.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
// node_modules/@radix-ui/react-tooltip/node_modules/@radix-ui/react-use-controllable-state/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
